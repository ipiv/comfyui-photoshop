...
const $ = document,
  ...
  sliderContainer2 = $.querySelector(".sliderContainer2"),
  ...
  sliderTxt2 = $.querySelector("#sliderTxt2"),
  ...
  sliderContainerBackground2 = $.querySelector(".sliderContainerBackground2"),
  ...
  sliderBackground2 = $.querySelector("#sliderBackground2"),
  sliderForground = $.querySelector("#sliderForground"),
  sliderForground2 = $.querySelector("#sliderForground2"),
  ...
  sliderValInput2 = $.querySelector("#sliderValInput2"),
